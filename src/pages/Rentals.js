...
//useWeb3ExecuteFunction will allow you to interact with smart contract//
...
const Rentals = () => {
  ...
  const handleSuccess = () => {
    dispatch({
      type: "success",
      message: `Congrats! Your stay at ${searchFilters.destination} is now booked!`,
  ...
  const handleNoAccount = () => {
    dispatch({
      type: "error",
      message: "You must connect your wallet to book a rental.",
      title: "Not Connected",
      position: "topL",
    });
  }
  ...
  useEffect(() => {
    async function fetchRentalsList() {
      const allRentals = Moralis.Object.extend("allRentals");
      const query = new Moralis.Query(allRentals);
  ...
  const bookRental = async function (start, end, id, dayPrice) {
    ...
    let options = {
      contractAddress: "0x6e1db9856572182764001a10d1E2d5a1136A8c6F",
                ...
                <div className={highLight === i ? "rentalDivH" : "rentalDiv"}>
                  ...
                  <div className="rentalInfo">
                    ...
                    <div className="bottomButton">
                      ...
                      text="Stay Here" />
                      <div className="price">
                        <Icon fill="#808080" size={10} svg="eth" /> {e.attributes.pricePerDay} / Day
                      </div>
                    </div>
                  </div>
                </div>
